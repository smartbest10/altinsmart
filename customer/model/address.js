...
const customercreateaddressModel = async (data, res) => {
  try {
    const { customerid, address, postalcode, country, state, city } = data;
...
const customerupdateaddressModel = async (data, res) => {
  try {
    const { addressid, address, postalcode, country, state, city } = data;
...
module.exports = {
  ...
  customersetdefaultaddressModel, customerretrievedefaultaddressModel
};
